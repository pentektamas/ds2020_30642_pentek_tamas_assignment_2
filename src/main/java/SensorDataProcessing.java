...
public class SensorDataProcessing implements DataProcessing {
    ...
    public List<SensorData> getData() {
        ...
        for (String s : start) {
            ...
            System.out.println("ID: " + this.patientID + " ST: " + newString[0] + " ET: " + newString[2] + " NAME: " + newString[4]);
        }
        System.out.println("DDDD: " + list.get(0).getEndTime());
        return list;
    }
    ...
    public List<String> getDataJson() {
        ...
        for (SensorData sensorData : activities) {
            try {
                //System.out.println(mapper.writeValueAsString(sensorData));
